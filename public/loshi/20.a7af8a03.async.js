webpackJsonp([20], {
    ...
    function N(e, I, M) {
      ...
      return function(N) {
        ...
        var r = [],
          ...
          T = (function(e) {
            function I() {
              return g(this, I), n(this, e.apply(this, arguments));
            }
            return (
              c(I, e),
              (I.peek = function() {
        ...
        return (T.displayName = 'SideEffect(' + t(N) + ')'), (T.canUseDOM = A.canUseDOM), T;
      };
    }
    var o = M('pgxq'),
      i = t(o),
  ...
  HBAr: function(e, I, M) {
    ...
    var t = M('YbOa'),
      ...
      O = T.a.createElement(
        ...
        null,
        'Copyright ',
        T.a.createElement(r.a, { type: 'copyright' }),
        ' rhymedys@gmail.com'
      ),
      L = (function(e) {
        function I() {
          return g()(this, I), A()(this, a()(I).apply(this, arguments));
        }
        return (
          o()(I, [
            {
              ...
              value: function() {
                var e = this.props,
                  ...
                  t = M.pathname,
                  g = 'Loshi Manager';
                return I[t] && I[t].name && (g = ''.concat(I[t].name, ' - Loshi Manager')), g;
              },
            },
            {
              key: 'render',
                      ...
                      T.a.createElement(
                        ...
                        T.a.createElement(
                          ...
                          T.a.createElement(
                            ...
                            T.a.createElement('span', { className: s.a.title }, ' Loshi Manager')
                          )
                        ),
                        T.a.createElement(
                          'div',
                          { className: s.a.desc },
                          ' a watcher platform front end'
                        )
                      ),
                      T.a.createElement(
                        j.Switch,
                        null,
                        Object(E.c)(M.path, I).map(function(e) {
                          return T.a.createElement(j.Route, {
                            key: e.key,
                            path: e.path,
                        ...
                        T.a.createElement(j.Redirect, {
                          exact: !0,
                          from: ''.concat(p.a.appRootPath, 'user'),
                          to: ''.concat(p.a.appRootPath, 'user/login'),
                        })
                      )
                    ),
                    T.a.createElement(w.a, { copyright: O })
                  )
                );
              },
            },
  ...
  c1Zx: function(e, I) {
    e.exports = {
      container: 'container___1qll8',
      content: 'content___1xAM2',
      top: 'top___dAPWE',
      header: 'header___3xyac',
      logo: 'logo___3yv0h',
      title: 'title___2SlIy',
      desc: 'desc___1uABx',
    };
  ...
  nnmc: function(e, I, M) {
    ...
    var c = M('pgxq'),
      N = M('/mFE'),
      o = M('EsmO');
    (n.prototype = Object.create(c.Component.prototype)),
      (n.displayName = 'DocumentTitle'),
      (n.propTypes = { title: N.string.isRequired }),
      (n.prototype.render = function() {
        return this.props.children ? c.Children.only(this.props.children) : null;
      }),
      (e.exports = o(t, g)(n));
  },
  oJ7G: function(e, I) {
    e.exports = function(e, I, M, t) {
      var g = M ? M.call(t, e, I) : void 0;
      if (void 0 !== g) return !!g;
      if (e === I) return !0;
      if ('object' != typeof e || !e || 'object' != typeof I || !I) return !1;
      var n = Object.keys(e),
        c = Object.keys(I);
      if (n.length !== c.length) return !1;
      for (var N = Object.prototype.hasOwnProperty.bind(I), o = 0; o < n.length; o++) {
        var i = n[o];
        if (!N(i)) return !1;
        var A = e[i],
          D = I[i];
        if (!1 === (g = M ? M.call(t, A, D, i) : void 0) || (void 0 === g && A !== D)) return !1;
      }
      return !0;
    };
  },
    ...
    var t = M('pgxq'),
      ...
      i = function(e) {
        ...
        return g.a.createElement(
          ...
          t && g.a.createElement('div', { className: o.a.copyright }, t)
        );
      };
    I.a = i;
  },
